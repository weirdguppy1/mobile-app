...
const data = (overrides: Partial<typeof blankProfile> = {}): OnboardingData => ({
  profile: { ...blankProfile, ...overrides }, photos: [], prompts: [],
});
...
export default function MainLayout() {
  return <Stack screenOptions={{ headerShown: false }} initialRouteName="discover" />;
}
```
